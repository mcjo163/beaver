    ...
    <div class="container">
        <div class="row">
            ...
            <div class="row">
                ...
                {* ---------------------------------------------------- *}
                    {* <ol>
                        {foreach $album['songs'] as $i=>$title}
                            <li>
                                <div class="button">
                                    <!-- Button trigger modal -->
                                    <button type="button" class="btn btn-link song" data-toggle="modal" data-target="#{$album_ids[$i]}">
                                        {$title}
                                    </button>
                                    <button type="button" class="btn btn-outline-dark btn-sm add float-right" data-toggle="modal" data-target="#playlist">+</button>
                                </div>
                                <!-- Modal -->
                                <div class="modal fade" id="{$album_ids[$i]}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title song" id="exampleModalLabel">{$title}</h5>
                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                    <span aria-hidden="true">&times;</span>
                                                </button>
                                            </div>
