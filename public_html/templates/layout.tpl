        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light sticky-top">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <div class="btn-group px-sm-2">
                    <a href="{$WEB_URL}/add_album.html" role="button" class="btn btn-outline-primary">Add Album</a>
                    <a href="{$WEB_URL}/account/account.html" role="button" class="btn btn-outline-primary">Profile</a>
                </div>
            </div>
        </nav>
